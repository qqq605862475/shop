<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\UPUPW_NP7.0\project\ldx\public/../application/admin\view\article\edit.html";i:1505872985;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Article/edit'); ?>" method="post"  enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title" required="" type="text" value=<?php echo $data1['title']; ?>>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($data1['pic'] != ''): ?>
                                                <img src=<?php echo $data1['pic']; ?> alt="">
                                                <?php else: ?>
                                                暂无缩略图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid" style="width: 100%;">
                                                    ...
                                                    <?php foreach($data2 as $arr): ?>
                                                    <option value='<?php echo $arr['id']; ?>'<?php if($arr['id'] == $data1['cateid']): ?>selected="selected"<?php endif; ?>><?php echo $arr['catename']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="desc" id="desc"><?php echo $data1['desc']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="keywords" placeholder="" name="keywords"  required="" type="text" value=<?php echo $data1['keywords']; ?>>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author" placeholder="" name="author" required="" type="text" value=<?php echo $data1['author']; ?>>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4">
                                                <label>
                                                    <input class="checkbox-slider slider-icon yesno" name="state" <?php if($data1['state'] == 1): ?>checked="checked"<?php endif; ?> type="checkbox">
                                        ...
                                        <div class="form-group">
                                            <label for="content" class="col-sm-2 control-label no-padding-right">文章描述</label>
                                            <div class="col-sm-6">
                                                <textarea name="content" id="content"><?php echo $data1['content']; ?></textarea>
                                            </div>
                                        </div>
