<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\UPUPW_NP7.0\project\ldx\public/../application/admin\view\tags\index.html";i:1505558071;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $arr['tagsname']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url("Tags/edit",array('id'=>$arr['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Tags/del",array('id'=>$arr['id'])); ?>')" class="btn btn-danger btn-sm shiny">
