<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\UPUPW_NP7.0\project\ldx\public/../application/admin\view\links\index.html";i:1505543702;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $arr['url']; ?></td>
                                            <td align="center"><?php echo !empty($arr['dec'])?$arr['dec']:'暂无描述'; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url("Links/edit",array('id'=>$arr['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Links/del",array('id'=>$arr['id'])); ?>')" class="btn btn-danger btn-sm shiny">
