<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\UPUPW_NP7.0\project\ldx\public/../application/admin\view\article\add.html";i:1505872985;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Article/add'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid" style="width: 100%;">
                                                    ...
                                                    <option value=<?php echo $arr['id']; ?>><?php echo $arr['catename']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4">
                                                <label>
                                                    <input class="checkbox-slider slider-icon yesno" name="state" checked="checked" type="checkbox">
