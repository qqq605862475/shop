<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\UPUPW_NP7.0\project\ldx\public/../application/admin\view\admin\list.html";i:1505868903;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url("Admin/edit",array('id'=>$arr['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <?php if($arr['id'] != 1): ?>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Admin/del",array('id'=>$arr['id'])); ?>')" class="btn btn-danger btn-sm shiny">
