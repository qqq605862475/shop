<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\cate\addcate.html";i:1505902984;s:84:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\header.html";i:1505725262;s:82:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\left.html";i:1505895143;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Cate/addCate'); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for=""
                                                   class="col-sm-2 control-label no-padding-right">所属名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="" placeholder=""
                                                       type="text" value="<?php echo $data['name']; ?>"  readonly>
                                            </div>
