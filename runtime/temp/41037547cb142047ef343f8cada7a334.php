<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\UPUPW\htdocs\shop\public/../application/index\view\Pay\pay.html";i:1506509249;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//                            console.log(area_id);
        ...
        <div class="address">
            ...
            <div class="d2">
                <a href="#" style="padding: 15px 10px"><span style="float: right;margin-right: 40px">共0件商品</span></a>
            </div>
        </div>
        ...
        <div class="all">
            <ul>
                <li>
                    <span>商品小计</span>
                    <span style="float: right">￥128.00</span>
                </li>
                <li>
                    <span>优惠</span>
