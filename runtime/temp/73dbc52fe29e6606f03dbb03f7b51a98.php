<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\goods\edit.html";i:1505984286;s:82:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\left.html";i:1506408253;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Goods/upd'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">商品分类</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="freez"
                                                   class="col-sm-2 control-label no-padding-right">是否冻结库存</label>
                                        ...
                                        <div class="form-group">
                                            <label for="recycle"
                                                   class="col-sm-2 control-label no-padding-right">是否删除</label>
