<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"C:\Users\Administrator\Desktop\UPUPW_NP7.0\shop\public/../application/index\view\index\index.html";i:1506389883;s:99:"C:\Users\Administrator\Desktop\UPUPW_NP7.0\shop\public/../application/index\view\Common\header.html";i:1506414800;}*/ ?>
    ...
    <div class='ym_hd_products'>
     ...
     <?php foreach($nav as $v): ?>
            <li style="background-image: url('https://img.yimishiji.com/v1/img/d816053f3e405749cfbaf338f9bb1e1e.jpg');">
                ...
                <a class='tier1_cate' href="<?php echo url('Index/lis',['id'=>$v[0]]); ?>"><?php echo $v[0]; ?></a>
                <ul>
                    <?php foreach($v[1] as $k): ?>
                    <li>
                        <a class='tier2_cate' href="<?php echo url('Index/lis',['id'=>$v[0].','.$k]); ?>"><?php echo $k; ?></a>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </li>
