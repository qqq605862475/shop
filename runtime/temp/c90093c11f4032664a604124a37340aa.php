<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\image\add.html";i:1506070381;s:82:"E:\upupw\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\left.html";i:1506058953;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Image/index',['id'=>$data['goods_id']]); ?>">图片列表</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Image/add',['id'=>$data['goods_id']]); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="name" placeholder="" name="goods_name"
                                                       required="" type="text" value="<?php echo $data['goods_name']; ?>" disabled>
                                            </div>
