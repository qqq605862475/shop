<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\cate\addtopcate.html";i:1505974064;s:78:"C:\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\header.html";i:1505974064;s:76:"C:\UPUPW_NP7.0\htdocs\shop\public/../application/admin\view\common\left.html";i:1505974064;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Cate/addTopCate'); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                   class="col-sm-2 control-label no-padding-right">顶级分类名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="catename" placeholder="" name="name"
                                                        type="text">
                                            </div>
